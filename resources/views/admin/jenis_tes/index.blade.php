                ...
                <div class="card-body">
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                        ...
                        @hasrole('Admin')
                        <td>
                            <a href="{{ route('jenis.edit',$item->id) }}"><span class="badge bg-warning">Edit</span></a>
                            <form action="{{ route('jenis.destroy',$item->id) }}" method="POST" onclick="return confirm('Are you sure?')">
                                @method('DELETE')
                                @csrf
